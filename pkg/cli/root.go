...
func Execute() {
	...
	runCmd.Flags().StringVarP(&opts.httpAddr, "httpaddr", "", ":3128", "proxy http listen address")
	runCmd.Flags().StringVarP(&opts.httpsAddr, "httpsaddr", "", ":3129", "proxy https listen address")
